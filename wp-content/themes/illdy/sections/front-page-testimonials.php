						...
						<div class="testimonials-carousel owl-carousel-enabled">
							<div class="carousel-testimonial">
								<div class="testimonial-image">
									...
									<img src="http://brother-group.net/wp-content/uploads/2016/06/logo.png" alt="<?php _e( 'babelkhalk resturant', 'illdy' ); ?>" title="<?php _e( 'babelkhalk resturant', 'illdy' ); ?>" />
								</div><!--/.testimonial-image-->
								<div class="testimonial-content">
									<blockquote><q><?php _e( 'we are so happy to work with you ,our website is amazing and we want to thank you for your efforts and your time', 'illdy' ); ?></q></blockquote>
								</div><!--/.testimonial-content-->
								<div class="testimonial-meta">
									<?php _e( 'babelkhalk resturant', 'illdy' ); ?>
								</div><!--/.testimonial-meta-->
							</div><!--/.carousel-testimonial-->
							<div class="carousel-testimonial">
								<div class="testimonial-image">
									<img src="http://brother-group.net/wp-content/uploads/2016/06/7asal.jpg" alt="<?php _e( '7asal magazine', 'illdy' ); ?>" title="<?php _e( '7asal magazine', 'illdy' ); ?>" />
								</div><!--/.testimonial-image-->
								<div class="testimonial-content">
									<blockquote><q><?php _e( 'I just want to say from the bottom of my heart thank you to the whole grouped who has helped me.They are just wonderful, wonderful group of people we worked with. Again a personal thank you for professionalism, a personal thank you for the time and extra time.', 'illdy' ); ?></q></blockquote>
								</div><!--/.testimonial-content-->
								<div class="testimonial-meta">
									<?php _e( '7asal magazine', 'illdy' ); ?>
								</div><!--/.testimonial-meta-->
							</div><!--/.carousel-testimonial-->
							<div class="carousel-testimonial">
								<div class="testimonial-image">
