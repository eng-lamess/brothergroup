...
if ( current_user_can( 'edit_theme_options' ) ) {
	...
	$email = get_theme_mod( 'illdy_email', __( 'contact@brother-group.net', 'illdy' ) );
	$phone = get_theme_mod( 'illdy_phone', __( '0235696887', 'illdy' ) );
	$address1 = get_theme_mod( 'illdy_address1', __( '24 Sahab St,from Ahmed Kamel St., ', 'illdy' ) );
	$address2 = get_theme_mod( 'illdy_address2', __( 'Giza,Egypt', 'illdy' ) );
